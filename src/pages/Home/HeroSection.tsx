      ...
      <div className="flex flex-col tems-center g:flex-row gap-16 w-full">
        ...
        >
          {/* <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2 }}
            className="inline-flex -rotate-3 items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border-blue-500/20 mb-8"
          >
          ...
          <p className="max-w-4xl relative font-extrabold tracking-tight text-5xl md:text-6xl">
            <span className="drop-shadow-xl drop-shadow-white/20">
              No chaos in the
              <motion.span className="text-cyan-300 drop-shadow-cyan-500/50">
                {" "}
                head!
              </motion.span>
            </span>
          ...
          <p className="text-md md:text-xl text-neutral-400 max-w-xl my-5">
        ...
        <motion.div
          ...
          className="flex-1 w-full flex itestrukt!ms-center justify-center "
        >
