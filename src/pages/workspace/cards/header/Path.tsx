...
export const Path = () => {
  ...
  return (
    <div className="flex w-full max-w-full items-center fixed bg-neutral-100 border-b-1 border-neutral-300 dark:border-neutral-700 dark:border-neutral-800 dark:bg-neutral-900 z-10 p-2">
