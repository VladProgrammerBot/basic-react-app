...
export const Bar = () => {
    ...
    return (
        <div className={`${isBarOpen ? "w-screen sm:w-75" : "w-0"} h-screen border-r-1 border-neutral-200 dark:border-neutral-900 pb-12 overflow-x-hidden fixed bg-white dark:bg-black z-100 duration-300`}>
