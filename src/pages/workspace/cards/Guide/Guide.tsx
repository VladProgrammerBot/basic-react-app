...
export const Guide = () => {
  ...
  const renderStepContent = (step: any) => {
    ...
    const blockBaseClass = "border p-4 mb-5 rounded-lg relative overflow-hidden before:absolute before:inset-y-0 before:left-0 before:w-1";
    const labelBaseClass = "text-[11px] uppercase tracking-[0.05em] font-bold mb-2 flex items-center gap-1.5";
    ...
    return (
      <div className="animate-slide-in">
        ...
        {step.problem && (
          <div className={`${blockBaseClass} bg-[rgba(127,29,29,0.2)] border-[rgba(248,113,113,0.2)] before:bg-[#f87171]`}>
        ...
        {step.solution && (
          <div className={`${blockBaseClass} bg-[rgba(20,83,45,0.2)] border-[rgba(74,222,128,0.2)] before:bg-[#4ade80]`}>
        ...
        {step.note && (
          <div className={`${blockBaseClass} bg-[rgba(161,98,7,0.15)] border-[rgba(250,204,21,0.2)] before:bg-[#facc15]`}>
            <div className={`${labelBaseClass} text-[#facc15]`}>💡 Підказка</div>
            <p>{step.note.text}</p>
          </div>
        )}
        ...
        {step.result && (
          <div className={`${blockBaseClass} bg-[rgba(20,83,45,0.2)] border-[rgba(74,222,128,0.2)] before:bg-[#4ade80]`}>
            <div className={`${labelBaseClass} text-[#4ade80]`}>✅ Результат</div>
        ...
        {step.tryYourself && (
          <div className={`${blockBaseClass} bg-[rgba(161,98,7,0.15)] border-[rgba(250,204,21,0.2)] before:bg-[#facc15]`}>
            <div className={`${labelBaseClass} text-[#facc15]`}>🚀 Спробуйте самі</div>
            <ol className="list-decimal list-inside space-y-1">
        ...
        {step.congratulations && (
          <div className="text-center py-5">
            ...
            <h3 className="text-lg font-semibold">{step.congratulations.text}</h3>
          </div>
        )}

        {step.message && (
          <div className={`${blockBaseClass} bg-[rgba(161,98,7,0.15)] border-[rgba(250,204,21,0.2)] before:bg-[#facc15]`}>
            <div className={`${labelBaseClass} text-[#facc15]`}>📚 Повідомлення</div>
      ...
      >
        <div className="relative p-5 md:px-6 border-b border-[#333336] flex justify-between items-start bg-white/[0.02] max-md:pt-6 max-md:before:content-[''] max-md:before:block max-md:before:w-10 max-md:before:h-1 max-md:before:bg-[#444] max-md:before:rounded-sm max-md:before:absolute max-md:before:top-2 max-md:before:left-1/2 max-md:before:-translate-x-1/2">
          <div className="guide-title">
            <h3 className="m-0 mb-1 text-lg font-semibold tracking-tight">Strukt Guide 📖</h3>
